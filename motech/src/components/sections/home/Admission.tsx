            ...
            <div className="w-full h-full relative">
                ...
                <div className="w-full h-full relative z-10 flex flex-col gap-2 items-center justify-center">
                    ...
                    <div className="flex w-full items-center justify-center gap-8 mt-12">
                        <Link 
                        href=""
                        className="bg-blue-800 font-extrabold text-white p-4 lg:px-10 rounded-[3px] transition-all duration-300 ease-in-out hover:scale-120"
                        >Apply Now</Link>
                        <Link 
                        href=""
                        className="font-extrabold text-white border-[2px] border-blue-800 bg-transparent backdrop-blur-md p-4 lg:px-10 rounded-[3px] transition-all duration-300 ease-in-out hover:scale-110"
